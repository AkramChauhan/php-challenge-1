<?php
require($_SERVER['DOCUMENT_ROOT'].'/includes/define.php');
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>404 Error - <?php echo APPNAME ?></title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="text-center mt-4">
                                    <img class="mb-4 img-error" src="<?php echo SITEURL ?>dist/images/404.svg" />
